...
switch (cmd)
{
    case "bench":
        Run(
            "dotnet",
            "run --project src/Maple.Native.Benchmarks/Maple.Native.Benchmarks.csproj"
    ...
    case "comparison-bench":
        Run(
            "dotnet",
            "run --project src/Maple.Native.ComparisonBenchmarks/Maple.Native.ComparisonBenchmarks.csproj"
                + " -c Release -- run",
            repoRoot
        );
        break;
    ...
    case "disasm":
        Run(
            "dotnet",
            "run --project src/Maple.Native.Benchmarks/Maple.Native.Benchmarks.csproj"
                + " -c Release -- --filter \"*Maple.Native*\" --disasm",
            repoRoot
        );
        break;
    ...
    case "publish-tester":
        ...
        Run(
            "dotnet",
            $"publish src/Maple.Native.Tester/Maple.Native.Tester.csproj -c Release -r {rid} --self-contained",
            repoRoot
        );
        break;
