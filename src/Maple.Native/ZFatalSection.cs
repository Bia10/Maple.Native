...
public readonly struct ZFatalSection(uint tibPointer, int refCount) : INativeSized
{
    /// <inheritdoc/>
    public static int NativeSize => ZFatalSectionLayout.TotalBytes;
...
/// <summary>
/// Memory layout of <c>ZSyncAutoUnlock&lt;ZFatalSection&gt;</c> — a lightweight RAII
/// guard that holds a pointer to the lock it owns:
/// <code>
/// struct ZSyncAutoUnlock&lt;ZFatalSection&gt;
/// {
///     ZFatalSection *m_pLock;  // +0x00  pointer to the guarded ZFatalSection
/// };  // sizeof = 0x04
/// </code>
/// </summary>
/// <remarks>
/// PDB source: <c>game_types.h</c> line 67202 (ordinal 8092).
/// Runtime-only type; the pointer is not meaningful in offline analysis
/// but is documented here for structural completeness.
/// </remarks>
public readonly ref struct ZSyncAutoUnlockLayout
{
    /// <summary>Byte offset of <c>m_pLock</c> — the guarded <see cref="ZFatalSectionLayout"/> pointer.</summary>
